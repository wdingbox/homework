...
(function () {
    ...
    e.extend(a.editor.prototype, {
        ...
        setData: function (l, m, n) {
            //alert("wei:) "+l);//convert php script as comments. Remeber to convert back before save in php.
            l = l.replace(/\<\?php /g,'&lt;!--\?php ');
            l = l.replace(/\?\>/g,'\?--&gt;');
            //alert(l);
        ...
        init: function (m) {
         //alert("new page");
            m.addCommand('newpage', {
                ...
                exec: function (n) {
                    var o = this;
                    if( false==confirm("are u sure to make new page for current doc? \n\n"+document.m_filename)) return;
